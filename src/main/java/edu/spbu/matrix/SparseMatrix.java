...
public class SparseMatrix implements Matrix
{
  ...
  @Override  public Matrix dmul(Matrix o){
    ...
    ConcurrentHashMap<Integer, HashMap<Integer, Double>> cmap = new ConcurrentHashMap<Integer, HashMap<Integer, Double>>(); //потокобезопасная реализация map
    for (int i=0; i<row; i++) {
    ...
    final ConcurrentHashMap<Integer, HashMap<Integer, Double>> csT = new ConcurrentHashMap<Integer, HashMap<Integer, Double>>(); //аналогично
    ...
    HashMap<Integer, HashMap<Integer, Double>> result = new HashMap<Integer, HashMap<Integer, Double>>();
    final ConcurrentHashMap<Integer, HashMap<Integer, Double>> cresult = new ConcurrentHashMap<Integer, HashMap<Integer, Double>>(); //делаем потокобезопасным и результат
